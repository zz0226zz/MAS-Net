...
parser.add_argument('--train_path', type=str,
                    default='/data/zz/seg/data/Synapse/train_npz', help='train root dir for data')
...
if __name__ == "__main__":
    ...
    dataset_config = {
        'Synapse': {
            "checkpoint_path" : './pth/{}_mas_{}_{}_{}'.format(args.model_name, args.base_lr,
                                                                               args.max_epochs, args.dataset),
            'list_dir': './lists/lists_Synapse',
            'num_classes': 9,
        },
        'ACDC': {
            "checkpoint_path" : './pth/{}_ACDC_{}_{}_{}'.format(args.model_name, args.base_lr,
                                                                              args.max_epochs, args.dataset),
